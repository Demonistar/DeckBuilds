...
def _patch_embedded_deck_implementation(source: str, log_fn=None) -> str:
    ...
    source = _replace_once(
        ...
        "        role_keywords = {\n"
        "            \"shell_bg\": {\"window\", \"root\", \"shell\", \"main\"},\n"
        ...
        "            \"\\nQWidget[runtime_theme_role=\\\"sidebar\\\"], QWidget[runtime_theme_role=\\\"journal\\\"] {\"\n"
        ...
        "            f\" background-color: {roles['button_hover']}; }}\"\n"
        "            \"\\nQLabel {\"\n"
        "            f\" color: {roles['text']}; }}\"\n"
        "            \"\\nQLabel[dim=\\\"true\\\"] {\"\n"
